...
extension ViewController {
    ...
    func setupTheConstraints() {
        ...
        orangeView.heightAnchor.constraint(equalTo: orangeView.widthAnchor, multiplier: 1).isActive = true
        ...
        yellowView.heightAnchor.constraint(equalTo: yellowView.widthAnchor, multiplier: 1).isActive = true
        ...
        blueView.heightAnchor.constraint(equalTo: blueView.widthAnchor, multiplier: 1).isActive = true
